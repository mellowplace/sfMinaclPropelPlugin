...
<?php if (isset($this->params['with_propel_route']) && $this->params['with_propel_route']): ?>
    $this->form = new <?php echo $this->getModelClass().'Form' ?>('<?php echo $this->getFormTemplate() ?>', $this->getRoute()->getObject());
<?php else: ?>
    ...
    $this->form = new <?php echo $this->getModelClass().'Form' ?>('<?php echo $this->getSingularName() ?>', '<?php echo $this->getFormTemplate() ?>', $<?php echo $this->getSingularName() ?>);
<?php endif; ?>
  }
